...
(2)Numerical linear algebra: Direct solution methods for linear systems, Gaussian
elimination and its variants; LU, QR, Singular value decomposition, Iterative methods for
a linear system, Stationary iterative methods- Jacobi, Gauss-Seidel, and successive
over-relaxation methods. Non-stationary iterative methods-conjugate gradient (CG),
convergence analysis; preconditioning. Estimation and computation of Â eigenvaluesGershgorin disc, power methods, the QR algorithm
